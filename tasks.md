...
| ID | Task | Area | Description | Initial Status |
| :--- | :--- | :--- | :--- | :--- |
| **T01** | Document project requirements | Requirements | Produce comprehensive SRS covering objectives, user persona, features, NFRs, scope, and user stories. | **TODO** |
| **T02** | Define supported frameworks | Requirements | Detail language bindings and conventions for Selenium, Playwright, and Cypress. | **BACKLOG** |
| **T03** | Define anti-pattern checklist | Analysis | Formalize detection rules and patterns for the initial 7 anti-pattern categories. | **BACKLOG** |
| **T04** | Define scoring system | Scoring | Formulate the mathematical deduction and weighting algorithm for quality scoring (0–100). | **BACKLOG** |
| **T05** | Design simple Streamlit UI | UI | Wireframe and plan the Streamlit layout (input panels, scorecard, and issue lists). | **BACKLOG** |
...
| **T12** | Generate fix suggestions | Reporting | Attach actionable one-line remediation advice to each detected violation. | **BACKLOG** |
